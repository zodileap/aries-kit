...
export const CustomLayout: React.FC = () => {
  ...
  const [loading, setLoading] = useState(true);
    ...
    "SortableList": `export const SortableList: React.FC = () => {
...
const [visible, setVisible] = useState(false);
  ...
  const navigate = useNavigate();
    ...
    "EdgeAlignedNav": `export const EdgeAlignedNav: React.FC = () => {
  const navigate = useNavigate();
...
`,
    "MediaUploadExample": `export const MediaUploadExample: React.FC = () => {
const editorRef = useRef<RichEditorInstance>(null);
  const [content, setContent] = useState([
    '# 媒体上传演示',
    '',
